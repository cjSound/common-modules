<!--
 * @Author: 曹捷
 * @Date: 2019-08-01 14:25:14
 * @LastEditors: 曹捷
 * @LastEditTime: 2020-04-26 15:56:28
...
<template>
  <div class="wscn-http404-container">
    <div class="wscn-http404">
      ...
      <div class="bullshit">
        <div class="bullshit__oops">哎呀 页面找不到!</div>
        <div class="bullshit__info">
          版权所有
          <a href="https://www.sanygroup.com/" style="color:#20a0ff" target="_blank">SANY</a>
        </div>
        <div class="bullshit__headline">{{ message }}</div>
        <div class="bullshit__info">请检查您输入的URL是否正确，或单击下面的按钮返回主页.</div>
        <a @click="$router.push({ path: '/' })" class="bullshit__return-home">返回 主页</a>
      </div>
    </div>
  </div>
</template>
